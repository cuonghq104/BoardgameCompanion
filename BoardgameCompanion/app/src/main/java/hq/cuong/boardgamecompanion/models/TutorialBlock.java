...
public class TutorialBlock {
    ...
    public TutorialBlock(String type, String title, String content, String imageUrl) {
        this.type = type;
        this.title = title;
    ...
    public static TutorialBlock createText(String title, String content) {
        return new TutorialBlock(TEXT_TYPE, title, content, null);
    }

    public static TutorialBlock createImage(String imageUrl) {
    ...
    public static final TutorialBlock[] TUTORIAL_BLOCKS = {
            ...
            TutorialBlock.createImage("http://2.bp.blogspot.com/_0Pz0L1XQR1k/TB-cjdrXS2I/AAAAAAAAAUw/PHjf91XHa9U/s320/fortune+teller.png"),
            TutorialBlock.createText("Tiên tri", "Mỗi đêm, khi được gọi dậy Tiên Tri sẽ chỉ một người. Nếu người đó là Sói Quản trò sẽ gật đầu.\n" ),
            TutorialBlock.createImage("http://1.bp.blogspot.com/-n_Ol3Hw7OTY/VGxC-hcsFYI/AAAAAAAABXI/bU3urwBQKK8/s1600/hunter.png"),
            TutorialBlock.createText("Thợ săn", "Khi thợ săn chết, dù là dưới bất kỳ hình thức nào cũng có thể chọn một người chơi khác và kéo hắn xuống “Tuyền đường” cùng Thợ Săn"),
            TutorialBlock.createImage("http://2.bp.blogspot.com/_0Pz0L1XQR1k/TB-d0OJIX_I/AAAAAAAAAU4/JNek6CgDWPM/s320/witch.png"),
            TutorialBlock.createText("Phù thủy", "Phù Thủy có hai bình thuốc: Một bình dùng để cứu một người, còn một bình dùng để giết một người. Mỗi đêm, Quản trò khi gọi Phù Thủy dậy sẽ cho Phù Thủy biết người bị giết bởi Sói đêm đó, và Phù Thủy được quyền quyết định xem có cứu người ấy hay không. Sau đó, quản trò sẽ hỏi xem Phù Thủy có dùng bình giết giết ai hay không. Một khi đã dùng bình thì Phù Thủy sẽ mất đi chức năng tương ứng, tuy nhiên vẫn được gọi dậy mỗi đêm và biết ai chết. Lưu ý: Nếu đêm đó Bảo Vệ đã Bảo Vệ đúng người thì Quản trò sẽ lắc tay, ra dấu là không ai chết cả."),
            TutorialBlock.createImage("http://4.bp.blogspot.com/_hqAyb8K3zT8/SJxPWu9T55I/AAAAAAAAA7c/lnxMUs99j-g/s320/cupid.jpg"),
            TutorialBlock.createText("Cupid", "Đầu mỗi ván chơi, Cupid sẽ được gọi dậy và chọn ra hai người yêu nhau. Cupid sau đó nhắm mắt lại và hai người yêu nhau sẽ được Quản Trò gọi dậy để biết mặt và Vai Trò của nhau. Nếu hai người thuộc hai phe khác nhau (Sói vs Dân) thì họ thành phe thứ ba với nhiệm vụ là hai người cuối cùng sống sót.")
